...
async fn tie_breaking_same_round_higher_node_id_wins() {
    ...
    let b_node1 = Ballot::new(5, NodeId(1)); // ballot (5, 1)
    let b_node2 = Ballot::new(5, NodeId(2)); // ballot (5, 2) - higher node_id
...
async fn tie_breaking_lower_node_id_rejected_same_round() {
    ...
    let b_node2 = Ballot::new(5, NodeId(2));
    let b_node1 = Ballot::new(5, NodeId(1)); // Lower node_id
...
async fn ballot_ordering_complete_comparisons() {
    ...
    let b1_1 = Ballot::new(1, NodeId(1));
    let b1_2 = Ballot::new(1, NodeId(2));
    let b2_1 = Ballot::new(2, NodeId(1));
    let b2_2 = Ballot::new(2, NodeId(2));
...
async fn acceptor_rejects_lower_node_id_when_already_promised_to_higher() {
    ...
    let b_higher_node = Ballot::new(5, NodeId(2));
    let b_lower_node = Ballot::new(5, NodeId(1));
...
async fn tie_breaking_affects_accept_phase() {
    ...
    let b_node1 = Ballot::new(5, NodeId(1));
    let b_node2 = Ballot::new(5, NodeId(2)); // Higher due to node_id
