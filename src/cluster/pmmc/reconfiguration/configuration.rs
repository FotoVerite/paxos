...
use crate::cluster::pmmc::reconfiguration::types::ReconfigError;
...
pub struct ClusterConfiguration {
    pub(super) id: u64,
    pub(super) status: ConfigurationStatus,
    pub(super) nodes: Vec<(Uuid, Roles)>,
    pub(super) strategy: ConfigurationStrategy,
    pub(super) epoch: usize,
    pub(super) alpha_max_inflight: usize,
    pub(super) checkpoint: Option<RsmCheckpoint>,
}
...
impl ClusterConfiguration {
    ...
    pub(super) fn next_epoch(&self) -> usize {
        self.epoch.clone() + 1
    }
