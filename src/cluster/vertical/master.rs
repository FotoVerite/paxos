...
use crate::{cluster::runtime::RuntimeNode, common::ballot::Ballot};
...
impl VerticalMaster {
    pub fn new(runtime: Arc<VerticalRuntime>) -> Self {
        Self {
            runtime,
...
#[async_trait]
impl RuntimeNode<VerticalMasterEvent> for VerticalMaster {
    fn id(&self) -> Uuid {
        Uuid::nil()
    }
